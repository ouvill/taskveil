...
pub const SYNC_LOCAL_HLC_METADATA_KEY: &str = "sync_local_hlc";
pub const SYNC_FULL_RESYNC_PAGE_TOKEN_METADATA_KEY: &str = "sync_full_resync_page_token";
pub const SYNC_FULL_RESYNC_COMPLETION_TOKEN_METADATA_KEY: &str =
    "sync_full_resync_completion_token";
pub const SYNC_UPGRADE_REQUIRED_METADATA_KEY: &str = "sync_upgrade_required_v2";
pub const KEY_ROTATION_PENDING_METADATA_KEY: &str = "key_rotation_pending_generation";
