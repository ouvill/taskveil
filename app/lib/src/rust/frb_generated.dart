...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiAccountRegistrationAckRecoveryKey();

  Future<AccountRegistrationPendingDto> crateApiAccountRegistrationBegin({
    required String email,
    String? serverUrl,
  });

  Future<void> crateApiAccountRegistrationCancel();

  Future<AccountAuthResultDto> crateApiAccountRegistrationComplete({
    required String password,
    String? deviceName,
  });

  Future<String?> crateApiAccountRegistrationRecoveryKey();

  Future<AccountRegistrationPendingDto> crateApiAccountRegistrationResend();

  Future<AccountRegistrationStateDto?> crateApiAccountRegistrationState();

  Future<void> crateApiAccountRegistrationVerifyOtp({required String otp});

  Future<bool> crateApiAckReminderNotificationCommand({
  ...
  Future<ReminderDto> crateApiCreateTaskReminder({
    required String taskId,
  ...
  crateApiListReminderNotificationCommands({
    required PlatformInt64 nowMs,
    required int limit,
  });
  ...
  Future<List<ReminderNotificationCommandDto>>
  crateApiPrepareReminderNotificationReconciliation({
    required PlatformInt64 nowMs,
  });
  ...
  Future<ReminderDto> crateApiUpdateReminder({
    required String reminderId,
    required PlatformInt64 remindAt,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiAccountRegistrationAckRecoveryKeyConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_ack_recovery_key",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiAccountRegistrationBeginConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_begin",
        argNames: ["email", "serverUrl"],
      );
  ...
  TaskConstMeta get kCrateApiAccountRegistrationCancelConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_cancel",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiAccountRegistrationCompleteConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_complete",
        argNames: ["password", "deviceName"],
      );
  ...
  TaskConstMeta get kCrateApiAccountRegistrationRecoveryKeyConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_recovery_key",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiAccountRegistrationResendConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_resend",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiAccountRegistrationStateConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_state",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiAccountRegistrationVerifyOtpConstMeta =>
      const TaskConstMeta(
        debugName: "account_registration_verify_otp",
        argNames: ["otp"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_i_64(revision, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 11,
  ...
  TaskConstMeta get kCrateApiAckReminderNotificationCommandConstMeta =>
      const TaskConstMeta(
        debugName: "ack_reminder_notification_command",
        argNames: ["reminderId", "revision"],
      );
  ...
  TaskConstMeta get kCrateApiCreateTaskReminderConstMeta => const TaskConstMeta(
    debugName: "create_task_reminder",
  ...
  TaskConstMeta get kCrateApiDeleteReminderConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiListReminderNotificationCommandsConstMeta =>
      const TaskConstMeta(
        debugName: "list_reminder_notification_commands",
        argNames: ["nowMs", "limit"],
      );
  ...
  TaskConstMeta
  get kCrateApiPrepareReminderNotificationReconciliationConstMeta =>
      const TaskConstMeta(
        debugName: "prepare_reminder_notification_reconciliation",
        argNames: ["nowMs"],
      );
  ...
  AccountRegistrationPendingDto dco_decode_account_registration_pending_dto(
    ...
    return AccountRegistrationPendingDto(
      ...
      nextRetryAtMs: dco_decode_i_64(arr[2]),
    );
  }
  ...
  AccountSessionStateDto dco_decode_account_session_state_dto(dynamic raw) {
    ...
    return AccountSessionStateDto(
      ...
      recoveryPending: dco_decode_bool(arr[5]),
    );
  }
  ...
  dco_decode_box_autoadd_account_registration_state_dto(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_account_registration_state_dto(raw);
  }
  ...
  dco_decode_list_reminder_notification_command_dto(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_reminder_notification_command_dto)
        .toList();
  }
  ...
  dco_decode_opt_box_autoadd_account_registration_state_dto(dynamic raw) {
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_account_registration_state_dto(raw);
  }
  ...
  ReminderNotificationActionDto dco_decode_reminder_notification_action_dto(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return ReminderNotificationActionDto.values[raw as int];
  }
  ...
  ReminderNotificationCommandDto dco_decode_reminder_notification_command_dto(
    ...
    return ReminderNotificationCommandDto(
      reminderId: dco_decode_String(arr[0]),
      platformId: dco_decode_i_32(arr[1]),
      revision: dco_decode_i_64(arr[2]),
      action: dco_decode_reminder_notification_action_dto(arr[3]),
      taskId: dco_decode_opt_String(arr[4]),
      listId: dco_decode_opt_String(arr[5]),
      scheduledAt: dco_decode_opt_box_autoadd_i_64(arr[6]),
    );
  }
  ...
  AccountRegistrationPendingDto sse_decode_account_registration_pending_dto(
    ...
    var var_nextRetryAtMs = sse_decode_i_64(deserializer);
    return AccountRegistrationPendingDto(
      email: var_email,
  ...
  AccountSessionStateDto sse_decode_account_session_state_dto(
    ...
    var var_recoveryPending = sse_decode_bool(deserializer);
    return AccountSessionStateDto(
      ...
      recoveryPending: var_recoveryPending,
    );
  }
  ...
  sse_decode_box_autoadd_account_registration_state_dto(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_account_registration_state_dto(deserializer));
  }
  ...
  sse_decode_list_reminder_notification_command_dto(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ReminderNotificationCommandDto>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_reminder_notification_command_dto(deserializer));
    }
    return ans_;
  }
  ...
  sse_decode_opt_box_autoadd_account_registration_state_dto(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_account_registration_state_dto(
        deserializer,
      ));
    } else {
      return null;
  ...
  ReminderNotificationActionDto sse_decode_reminder_notification_action_dto(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return ReminderNotificationActionDto.values[inner];
  }
  ...
  void sse_encode_account_registration_pending_dto(
    ...
    sse_encode_i_64(self.nextRetryAtMs, serializer);
  }
  ...
  void sse_encode_account_session_state_dto(
    ...
    sse_encode_bool(self.recoveryPending, serializer);
  }
  ...
  void sse_encode_box_autoadd_account_registration_state_dto(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_account_registration_state_dto(self, serializer);
  }
  ...
  void sse_encode_list_reminder_notification_command_dto(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_reminder_notification_command_dto(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_account_registration_state_dto(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_account_registration_state_dto(self, serializer);
    }
  }
  ...
  void sse_encode_reminder_notification_command_dto(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.reminderId, serializer);
    sse_encode_i_32(self.platformId, serializer);
    sse_encode_i_64(self.revision, serializer);
    sse_encode_reminder_notification_action_dto(self.action, serializer);
    sse_encode_opt_String(self.taskId, serializer);
