...
export TASKVEIL_AUTH_LIMIT_HMAC_KEY="${TASKVEIL_AUTH_LIMIT_HMAC_KEY:-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=}"
export TASKVEIL_AUTH_LIMIT_HMAC_KEY_GENERATION="${TASKVEIL_AUTH_LIMIT_HMAC_KEY_GENERATION:-1}"
